            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div class="mt-16">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                        <a href="https://laravel.com/docs" class="scale-100 bg-white from-gray-700/50 via-transparent shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500 hover:bg-rose-500/80 group">
                            <div class="relative w-full">
                                ...
                                <div class="hidden group-hover:block border border-white p-4 absolute top-4 bottom-4 left-4 right-4">
